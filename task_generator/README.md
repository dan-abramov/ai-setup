...
6. При `ERROR` пользователь получает код ошибки. Для `E204-E209` и `E301` доступно действие `Повторить`.
7. После закрытия вкладки задачу можно открыть повторно по URL `/task/:id`.
